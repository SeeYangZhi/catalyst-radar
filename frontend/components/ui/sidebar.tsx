...
function SidebarMenuSkeleton({
  ...
  // Random width between 50 to 90% — decorative jitter so a column of
  // skeleton rows doesn't look like a perfect rectangle. Stable per-mount
  // via useMemo; varying it on re-render would itself cause flicker.
