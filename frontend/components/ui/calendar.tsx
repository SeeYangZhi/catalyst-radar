  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        // DESIGN.md reserves accent-blue as a signal color, not a surface
        // fill. Day cells (range, today) use surface-2 lift instead; the
        // selected day still uses bg-primary (white pill on dark) via the
        // CalendarDayButton selected class.
        range_start: cn(
          "rounded-l-md bg-surface-2",
          defaultClassNames.range_start
        ),
        range_middle: cn(
          "rounded-none bg-surface-2/60",
          defaultClassNames.range_middle
        ),
        range_end: cn("rounded-r-md bg-surface-2", defaultClassNames.range_end),
        today: cn(
          "rounded-md bg-surface-2 text-ink data-[selected=true]:rounded-none",
